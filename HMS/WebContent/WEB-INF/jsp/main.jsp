                ...
                <div class="pf-user-panel">
                    <ul class="pf-user-opt">
                        <li>
                            <a href="javascript:;">
                                <i class="iconfont">&#xe60d;</i>
                                <span class="pf-opt-name" style="width:100px">用户信息</span>
                            </a>
                        </li>
                        <li  id="exit">
            ...
            <div id="pf-sider">
                ...
                <ul class="sider-nav" id="sider-nav">
			                      ...
			                      <%--        <c:forEach items="${userModule.secondModules }" var="secondModule"> --%>
			                        		 <li><a href="javascript:addPanel('0001' ,'${pageContext.request.contextPath}/identity/user/selectUser.jspx','用户管理');">用户管理</a></li>
			                       			 <li><a href="javascript:addPanel('0002' ,'${ctx}/identity/role/selectRole.jspx','角色管理');">角色管理</a></li>
			                       			 <li><a href="javascript:addPanel('0003' ,'${ctx }/identity/module/mgrModule.jspx','菜单管理');">菜单管理</a></li>
            ...
            <div id="pf-page">
                <div class="easyui-tabs" id="tt" style="width:100%;height:100%;">
                  <div title="当前用户" id="user" style="padding:10px 5px 5px 10px;">
                    	<iframe class="page-iframe" src="${ctx}/identity/user/home.jspx" frameborder="no"   border="no" height="100%" width="100%" scrolling="auto"></iframe>
                  </div>
                </div>
            </div>
        </div>
